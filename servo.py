...
#pwm.ChangeDutyCycle(5) # left -90 deg position # sleep(1)
#pwm.ChangeDutyCycle(7.5) # neutral position # sleep(1)
#pwm.ChangeDutyCycle(10) # right +90 deg position #sleep(1)
